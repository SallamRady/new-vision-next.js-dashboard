                ...
                <MenuList>
                  <div className='flex items-center plb-2 pli-4 gap-2' tabIndex={-1}>
                    ...
                    <div className='flex items-start flex-col'>
                      ...
                      <Typography variant='caption'>sallamrady@gmail.com</Typography>
                    </div>
                  </div>
                  ...
                  <MenuItem className='gap-3 pli-4' onClick={e => handleDropdownClose(e)}>
                    ...
                    <Typography color='text.primary'>الأعدادات</Typography>
                  </MenuItem>
                  <MenuItem className='gap-3 pli-4' onClick={e => handleDropdownClose(e)}>
                    <i className='ri-money-dollar-circle-line' />
                    <Typography color='text.primary'>الأشتركات</Typography>
                  </MenuItem>
                  <MenuItem className='gap-3 pli-4' onClick={e => handleDropdownClose(e)}>
